...
- [ ] Rename all "my" symbol names with "zy".
...
Function to rename the current buffer and file at the same time. This is from
[[https://emacsredux.com/blog/2013/05/04/rename-file-and-buffer/][Rename File and Buffer | Emacs Redux]].
