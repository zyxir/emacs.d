...
Define a series of shortcuts for org-roam. Use prefix =C-z=, as its
original function is useless and it's pretty handy.

#+begin_src emacs-lisp
  (define-prefix-command 'my/org-roam-map)
  (global-set-key (kbd "C-z") 'my/org-roam-map)
